...
int index = 15, start = 0, flag_uart = 0, tmp_start = 0;
int data_x[100], data_y[100], data_z[100], data_g[100];
int tmp_data_x_lcd[100], tmp_data_y_lcd[100], tmp_data_z_lcd[100];
...
void HardFault_Handler(void) {
  printf("Hard Fault exception occured");
}
