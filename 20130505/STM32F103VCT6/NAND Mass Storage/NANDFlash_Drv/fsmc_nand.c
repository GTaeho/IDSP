...
/* Private variables ---------------------------------------------------------*/
static uint8_t NAND_TxBuffer[NAND_PAGE_SIZE];
static uint8_t NAND_RxBuffer[NAND_PAGE_SIZE];
...
void FSMC_NAND_Init(void) {
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6;
  //GPIO_Init(GPIOG, &GPIO_InitStructure);  // This pin isn't exist on LQFP100 type
