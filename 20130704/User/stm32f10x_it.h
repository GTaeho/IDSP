...
typedef struct {
  volatile int axis_x_for_net[100];
  volatile int axis_y_for_net[100];
  volatile int axis_z_for_net[100];
  volatile int ATFCBit_net[100];
}AXISNETBUF;

typedef struct {
  volatile int tmp_gal_x[100];
  volatile int tmp_gal_y[100];
  volatile int tmp_gal_z[100];
}GALBUF;
