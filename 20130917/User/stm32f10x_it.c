...
volatile bool ParseUSART1;

// GPS USART3 buffer
volatile unsigned char GPS_Buffer[MaxSize];
volatile unsigned char GPSRxCounter;
...
void EXTI9_5_IRQHandler(void) {
  ...
  if(EXTI_GetITStatus(EXTI_Line7) != RESET) {
    ...
    printf("RTC Year = %d\r\n", GetYearAndMergeToInt());
    printf("RTC Month = %d\r\n", GetMonthAndMergeToInt());
    printf("RTC Day = %d\r\n", GetDayAndMergeToInt());
    printf("RTC Hour = %d\r\n", THH);
    printf("RTC Minute = %d\r\n", TMM);
    printf("RTC Second = %d\r\n\r\n", TSS);
